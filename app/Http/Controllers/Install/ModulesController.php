    ...
    public function index()
    {
     ...
     //   dd($modules);
        foreach ($modules as $module => $details) {
            ...
            //Install Link.
            try {
                $modules[$module]['install_link'] =route($details['alias'].'.install'); 
            ...
            //Update Link.
            try {
                $modules[$module]['update_link'] = route($details['alias'].'.update'); 
            ...
            //Uninstall Link.
            try {
                $modules[$module]['uninstall_link'] = route($details['alias'].'.uninstall'); 
