                                ...
                                <div class="col-lg-6 pt-5 pb-5">
                                    <div class="p-lg-5 p-4">
                                        ...
                                        <div class="mt-4">
                                            <form action="{{ route('login') }}" method="POST">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control @error('email') is-invalid @enderror" value="{{ old('email', 'admin@pulpitdma.com') }}" id="username" name="email" placeholder="Enter username">
                                                    @error('email')
                                        ...
                                        <div class="mt-5 text-center">
                                            <p class="mb-0">Don't have an account ? <a href="auth-signup-cover" class="fw-semibold text-primary text-decoration-underline"> Signup</a>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center text-white">
                            ...
                            </script>  . Crafted with <i class="mdi mdi-heart text-danger"></i> by <a href="pulpitdma.com" class="text-white">PULPiT DMA</a></p>
                        </div>
                    </div>
                </div>
            </div>
