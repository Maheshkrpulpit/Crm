                        ...
                        <div class="row g-4 align-items-center">
                            ...
                            <div class="col-sm-auto ms-auto">
                                <div class="hstack gap-2">
                                    ...
                                    <button type="button" class="btn btn-success add-btn" data-bs-toggle="modal" id="create-btn" data-bs-target="#showModal"><i class="ri-add-line align-bottom me-1"></i> new academic year</button>
                                ...
                                <table class="table align-middle" id="customerTable">
                                    <thead class="table-light">
                                        <tr>
                                            ...
                                            <th class="sort" data-sort="Category">Active Academic Year</th>
                                            <th class="sort" data-sort="Category_Id">Start date</th>
                                    ...
                                    <form class="tablelist-form" autocomplete="off">
                                        <div class="modal-body">
                                            ...
                                            <div class="row g-3">
                                                <div class="col-lg-6">
                                                    <div>
                                                        <label for="leadname-field" class="form-label">Start date</label>
                                                        <input type="text" id="duedate-field" class="form-control flatpickr-input active" data-provider="flatpickr" data-date-format="d M, Y" placeholder="Start date" required="" readonly="readonly">
                                                       
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div>
                                                        <label for="leadname-field" class="form-label">End date</label><input type="text" id="duedate-field" class="form-control flatpickr-input active" data-provider="flatpickr" data-date-format="d M, Y" placeholder="End date" required="" readonly="readonly">
                                                        
                                                    </div>
                                                </div>
                                                <div class="col-lg-12">
                                                    <div>
                                                        <label for="leadname-field" class="form-label">Academic Year Name</label>
                                                        <input type="text" id="leadname-field"  class="form-control" placeholder="AY 2017-2018" required />
                                                    </div>
                                                </div>
                                        ...
                                        <div class="modal-footer">
                                            <div class="hstack gap-2 justify-content-end">
                                                ...
                                                <button type="submit" class="btn btn-success" id="add-btn">Create academic year</button>
