...
@section('title') @lang('Brands') @endsection
@section('content')
    @component('components.breadcrumb')
        @slot('li_1') @lang('Admin') @endslot
        @slot('li_2') @lang('Master') @endslot
        @slot('title')@lang('Brands') @endslot
    @endcomponent
                ...
                <div class="card border-top border-primary" id="invoiceList">
                    <div class="card-header border border-dashed ">
                        <div class="d-flex align-items-center">
                            <h5 class="card-title mb-0 flex-grow-1">@lang('Brand List All')</h5>
                                ...
                                <div class="d-flex gap-2 flex-wrap">
                                    ...
                                    @can('brands.access')
                                        <a href="javascript:void(0)"
                                           data-href="{{route('master.brands.create')}}"
                                           class="btn btn-info addRecordBtn"><i
                                                    class="ri-add-line align-bottom me-1"></i> {{lang('Add Brand')}}
                                        </a>
                                    @endcan
                                </div>
                            </div>
