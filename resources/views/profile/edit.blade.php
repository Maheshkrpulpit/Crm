                          ...
                          <form action="{{route('user.profile.update',$user->id)}}" method="post">
                            ...
                            @method('PUT')
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            <label for="firstnameInput" class="form-label">@lang('locale.labels.first_name')</label>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            <label for="lastnameInput" class="form-label">
                                                @lang('locale.labels.last_name')</label>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            <label for="phonenumberInput" class="form-label">@lang('locale.labels.mobile')</label>
                                            <input type="text" class="form-control" name="phone" id="phonenumberInput"
                                                placeholder="@lang('locale.placeholders.phone')" value="{{$user->phone}}">
                                        </div>
                                    </div>
                                    <!--end col-->
                                    <div class="col-lg-6">
                             ...
                             <!--        <div class="col-lg-12">
                                        <div class="mb-3">
                                            <label for="JoiningdatInput" class="form-label">Joining
                                                Date</label>
                                            <input type="text" readonly class="form-control" data-provider="flatpickr"
                                    ...
                                    <div class="col-lg-12">
                                        <div class="hstack gap-2 justify-content-end">
                                            <button type="submit" class="btn btn-primary">@lang('locale.buttons.update')</button>
