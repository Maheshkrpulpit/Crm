        ...
        <div class="col-12 col-lg-auto order-last order-lg-0">
            <div class="row text text-white-50 text-center">
                <div class="flex-shrink-0">
                    <a href="{{route('user.profile.edit',$user->id)}}" class="btn btn-success"><i class="ri-edit-box-line align-bottom"></i> Edit Profile</a>
                </div>
            </div>
        </div>
        <!--end col-->
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-borderless mb-0">
                                            <tbody>
                                                <tr>
                                                    <th class="ps-0" scope="row">@lang('locale.labels.fullname') :</th>
                                                    <td class="text-muted">{{$user->first_name.' '.$user->last_name}}</td>
                                                </tr>
                                                <tr>
                                                    <th class="ps-0" scope="row">@lang('locale.labels.mobile') :</th>
                                                    <td class="text-muted">{{$user->phone}}</td>
                                                </tr>
                                                <tr>
                                                    <th class="ps-0" scope="row">@lang('locale.labels.email'):</th>
                                                ...
                                                <tr>
                                                    <th class="ps-0" scope="row">@lang('locale.labels.joining_date')</th>
