		...
		Array.from(flatpickrExamples).forEach(function (item) {
			if (item.getAttribute("data-provider") == "flatpickr") {
				...
				if (isFlatpickerVal["data-multiple-date"]) {
					...
					dateData.dateFormat = isFlatpickerVal["data-date-format"].value.toString();
					dateData.defaultDate = JSON.parse(isFlatpickerVal["data-deafult-date"].value.toString().replace(/&quot;/g,'"'));
				...
				if(isFlatpickerVal['data-month-change'])
				{
					dateData.onMonthChange=function(selectedDates,seldate,instance){
					 
					   updateDataByMonth(selectedDates,seldate,instance);
